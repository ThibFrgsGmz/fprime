    ...
    def _strip_without_code(self, line_list):
        ...
        for line in line_list:
            ...
            if "@code" in line and code_flag == False:
                ...
                new_line_list.append(line.strip())
                code_flag = False
            elif "@code" not in line and code_flag == True:
    ...
    def commentDraw(self, user_comment, arguments, type="iface", check_and_send=False):
        ...
        for index in range(start, end):
            ...
            if line.strip() == "@code":
                ...
                trimwhitespace = True
            elif trimwhitespace == False and line.strip() == "@code":
                trimwhitespace = True
            elif trimwhitespace == False and line.strip() == r"\code":
                trimwhitespace = True
...
class Formatters:
    ...
    def msgUnionArgName(self, msg_type):
        ...
        new_name = "".join(f"_{c.lower()}" if c.isupper() == True else c for c in name)
        return new_name[1:]
    ...
    def simpleFuncDraw(self, name, args, proto=True, indent=0):
        ...
        if len(args) == 0:
            ...
            function_str = f"{name.strip()}();" if proto == True else name.strip() + "() {"
            return function_str
        ...
        if len(args) == 1:
            ...
            if proto == True:
                function_str = f"{name.strip()}({a[0]} {a[1]});"
            else:
                function_str = f"{name.strip()}({a[0]} {a[1]}" + ") {"
